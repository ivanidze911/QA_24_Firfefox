...
public class Hw_MyWaiters {
    private final WebDriver driver;

    public Hw_MyWaiters(WebDriver driver) {
        this.driver = driver;
    }
    ...
    public Boolean waitElementToBeSelectedReturn(By by){
        return fluentWait(EXPLICITY_WAIT).until(ExpectedConditions.elementToBeSelected(by));
    }
    public Boolean waitElementToBeSelectedReturn(WebElement element){
    ...
    public void waitingPresenceOfElementLocated(By by) {
        waitForFunction(ExpectedConditions.presenceOfElementLocated(by), EXPLICITY_WAIT);
    }
    public void waitingTextToBePresentInElementValue(WebElement element, String string){
        waitForFunction(ExpectedConditions.textToBePresentInElementValue(element,"text"), EXPLICITY_WAIT);
    }
    public void waitingForAnElementToDisappear (By by){
        waitForFunction(ExpectedConditions.invisibilityOfElementLocated(by), EXPLICITY_WAIT);
    }
    public void waitingForPageTitle(String text) {
